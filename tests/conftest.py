...
def mock_security_manager(mock_config):
    ...
    mock_security.validate_database_name = Mock(return_value=(True, "Database name validation passed"))
    ...
    mock_security.get_security_stats = Mock(return_value={
        'active_api_keys': 0,
...
def mock_tools_manager(mock_db_connection):
    ...
    mock_tools.get_tool_statistics = Mock(return_value={
        "total_tools": 6,
        "modules": 3,
        "tools_by_module": {
            "DatabaseTools": 4,
        ...
        "available_tools": [
            "connect_database", "list_databases", "list_tables", 
            "get_table_schema", "get_incidents", "get_deployments"
        ]
    })
    return mock_tools
